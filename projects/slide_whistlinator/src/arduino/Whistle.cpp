/* ------------------------------------------------------------
author: "Terry Feng (tzfeng@stanford.edu)"
copyright: "Terry Feng"
name: "Whistle", "Slide Whistle"
version: "1.0"
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("author", "Terry Feng (tzfeng@stanford.edu)");
		...
		m->declare("copyright", "Terry Feng");
		m->declare("delays.lib/name", "Faust Delay Library");
		m->declare("delays.lib/version", "0.1");
		m->declare("description", "Nonlinear WaveGuide Slide Whistle + Additive Synthesis, adapted from Romain Michon");
		...
		m->declare("filename", "Whistle.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst8 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst7) / mydsp_faustpower2_f(fConst5) + -1.0f));
		...
		iConst17 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst1 - fConst16)));
		fConst18 = 44.1f / fConst0;
		fConst19 = 1.0f - fConst18;
		fConst20 = 3.0f / fConst0;
		fConst21 = 2.05f / fConst0;
		fConst22 = 2.0f / fConst0;
		fConst23 = 1.0f / fConst0;
		fConst24 = std::max<float>(1.0f, 0.1f * fConst0);
		fConst25 = 1.0f / fConst24;
		fConst26 = 0.5f * fConst0;
		fConst27 = 1.0f / std::max<float>(1.0f, fConst26);
		fConst28 = 0.1f / std::max<float>(1.0f, 0.2f * fConst0);
		fConst29 = 0.25f * fConst0;
		float fConst30 = 1.0f / std::tan(15707.963f / fConst0);
		fConst31 = 1.0f - fConst30;
		fConst32 = 1.0f / (fConst30 + 1.0f);
		iConst33 = int(std::min<float>(2.7e+03f, std::max<float>(0.0f, 0.06f * fConst0)));
		iConst34 = int(std::min<float>(2048.0f, std::max<float>(0.0f, fConst16 + -1.0f)));
		float fConst35 = std::floor(0.153129f * fConst0 + 0.5f);
		float fConst36 = (0.0f - 6.9077554f * fConst35) / fConst0;
		float fConst37 = std::exp(0.5f * fConst36);
		float fConst38 = mydsp_faustpower2_f(fConst37);
		float fConst39 = 1.0f - fConst38;
		float fConst40 = 1.0f - fConst6 * fConst38;
		float fConst41 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst40) / mydsp_faustpower2_f(fConst39) + -1.0f));
		float fConst42 = fConst40 / fConst39;
		fConst43 = fConst42 - fConst41;
		fConst44 = std::exp(0.33333334f * fConst36) / fConst37 + -1.0f;
		fConst45 = fConst37 * (fConst41 + (1.0f - fConst42));
		float fConst46 = std::floor(0.020346f * fConst0 + 0.5f);
		iConst47 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst35 - fConst46)));
		...
		float fConst51 = std::exp(0.5f * fConst50);
		float fConst52 = mydsp_faustpower2_f(fConst51);
		float fConst53 = 1.0f - fConst52;
		float fConst54 = 1.0f - fConst6 * fConst52;
		float fConst55 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst54) / mydsp_faustpower2_f(fConst53) + -1.0f));
		float fConst56 = fConst54 / fConst53;
		fConst57 = fConst56 - fConst55;
		fConst58 = std::exp(0.33333334f * fConst50) / fConst51 + -1.0f;
		fConst59 = fConst51 * (fConst55 + (1.0f - fConst56));
		float fConst60 = std::floor(0.031604f * fConst0 + 0.5f);
		iConst61 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst49 - fConst60)));
		...
		float fConst65 = std::exp(0.5f * fConst64);
		float fConst66 = mydsp_faustpower2_f(fConst65);
		float fConst67 = 1.0f - fConst66;
		float fConst68 = 1.0f - fConst6 * fConst66;
		float fConst69 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst68) / mydsp_faustpower2_f(fConst67) + -1.0f));
		float fConst70 = fConst68 / fConst67;
		fConst71 = fConst70 - fConst69;
		fConst72 = std::exp(0.33333334f * fConst64) / fConst65 + -1.0f;
		fConst73 = fConst65 * (fConst69 + (1.0f - fConst70));
		float fConst74 = std::floor(0.013458f * fConst0 + 0.5f);
		iConst75 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst63 - fConst74)));
		iConst76 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst74 + -1.0f)));
		float fConst77 = std::floor(0.210389f * fConst0 + 0.5f);
		float fConst78 = (0.0f - 6.9077554f * fConst77) / fConst0;
		float fConst79 = std::exp(0.5f * fConst78);
		float fConst80 = mydsp_faustpower2_f(fConst79);
		float fConst81 = 1.0f - fConst80;
		float fConst82 = 1.0f - fConst6 * fConst80;
		float fConst83 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst82) / mydsp_faustpower2_f(fConst81) + -1.0f));
		float fConst84 = fConst82 / fConst81;
		fConst85 = fConst84 - fConst83;
		fConst86 = std::exp(0.33333334f * fConst78) / fConst79 + -1.0f;
		fConst87 = fConst79 * (fConst83 + (1.0f - fConst84));
		float fConst88 = std::floor(0.024421f * fConst0 + 0.5f);
		iConst89 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst77 - fConst88)));
		iConst90 = int(std::min<float>(2048.0f, std::max<float>(0.0f, fConst88 + -1.0f)));
		float fConst91 = std::floor(0.192303f * fConst0 + 0.5f);
		float fConst92 = (0.0f - 6.9077554f * fConst91) / fConst0;
		float fConst93 = std::exp(0.5f * fConst92);
		float fConst94 = mydsp_faustpower2_f(fConst93);
		float fConst95 = 1.0f - fConst94;
		float fConst96 = 1.0f - fConst6 * fConst94;
		float fConst97 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst96) / mydsp_faustpower2_f(fConst95) + -1.0f));
		float fConst98 = fConst96 / fConst95;
		fConst99 = fConst98 - fConst97;
		fConst100 = std::exp(0.33333334f * fConst92) / fConst93 + -1.0f;
		fConst101 = fConst93 * (fConst97 + (1.0f - fConst98));
		float fConst102 = std::floor(0.029291f * fConst0 + 0.5f);
		iConst103 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst91 - fConst102)));
		iConst104 = int(std::min<float>(2048.0f, std::max<float>(0.0f, fConst102 + -1.0f)));
		float fConst105 = std::floor(0.256891f * fConst0 + 0.5f);
		float fConst106 = (0.0f - 6.9077554f * fConst105) / fConst0;
		float fConst107 = std::exp(0.5f * fConst106);
		float fConst108 = mydsp_faustpower2_f(fConst107);
		float fConst109 = 1.0f - fConst108;
		float fConst110 = 1.0f - fConst6 * fConst108;
		float fConst111 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst110) / mydsp_faustpower2_f(fConst109) + -1.0f));
		float fConst112 = fConst110 / fConst109;
		fConst113 = fConst112 - fConst111;
		fConst114 = std::exp(0.33333334f * fConst106) / fConst107 + -1.0f;
		fConst115 = fConst107 * (fConst111 + (1.0f - fConst112));
		float fConst116 = std::floor(0.027333f * fConst0 + 0.5f);
		iConst117 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst105 - fConst116)));
		iConst118 = int(std::min<float>(2048.0f, std::max<float>(0.0f, fConst116 + -1.0f)));
		float fConst119 = std::floor(0.219991f * fConst0 + 0.5f);
		float fConst120 = (0.0f - 6.9077554f * fConst119) / fConst0;
		float fConst121 = std::exp(0.5f * fConst120);
		float fConst122 = mydsp_faustpower2_f(fConst121);
		float fConst123 = 1.0f - fConst122;
		float fConst124 = 1.0f - fConst6 * fConst122;
		float fConst125 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst124) / mydsp_faustpower2_f(fConst123) + -1.0f));
		float fConst126 = fConst124 / fConst123;
		fConst127 = fConst126 - fConst125;
		fConst128 = std::exp(0.33333334f * fConst120) / fConst121 + -1.0f;
		fConst129 = fConst121 * (fConst125 + (1.0f - fConst126));
		float fConst130 = std::floor(0.019123f * fConst0 + 0.5f);
		iConst131 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst119 - fConst130)));
		iConst132 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst130 + -1.0f)));
		float fConst133 = 1979.2034f / fConst0;
		fConst134 = (1.0f - fConst133) / (fConst133 + 1.0f);
		fConst135 = 0.0f - std::cos(fConst133) * (fConst134 + 1.0f);
		float fConst136 = 9424.778f / fConst0;
		fConst137 = (1.0f - fConst136) / (fConst136 + 1.0f);
		fConst138 = 0.0f - std::cos(fConst136) * (fConst137 + 1.0f);
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(261.6f);
		fHslider1 = FAUSTFLOAT(0.96f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Whistle");
		ui_interface->addHorizontalSlider("freq", &fHslider0, FAUSTFLOAT(261.6f), FAUSTFLOAT(261.6f), FAUSTFLOAT(1046.4f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("pressure", &fHslider1, FAUSTFLOAT(0.96f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.99f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = fConst18 * float(fHslider0);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec1[IOTA0 & 2047] = 0.35355338f * fRec10[0] + 1e-20f;
			fRec13[0] = fSlow0 + fConst19 * fRec13[1];
			fRec12[0] = fRec12[1] + fConst20 * fRec13[0] - std::floor(fRec12[1]);
			fRec14[0] = fSlow1 + 0.999f * fRec14[1];
			float fTemp0 = std::max<float>(0.0f, std::min<float>(0.99f, fRec14[0]));
			float fTemp1 = fRec13[0] + 1.0f;
			fRec15[0] = fRec15[1] + fConst21 * fTemp1 - std::floor(fRec15[1]);
			fRec16[0] = fRec16[1] + fConst22 * fTemp1 - std::floor(fRec16[1]);
			fRec17[0] = fRec17[1] + fConst23 * fTemp1 - std::floor(fRec17[1]);
			int iRec18 = 0;
			float fTemp2 = float(iRec18);
			iRec19[0] = (iVec0[1] >= 1) * iRec19[1] + 1;
			float fTemp3 = float(iRec19[0]);
			float fTemp4 = fConst25 * fTemp3;
			float fTemp5 = std::max<float>(0.0f, std::min<float>(fTemp4, 1.0f) - fConst25 * fTemp2);
			fRec20[0] = 0.999f * fRec20[1];
			float fTemp6 = fConst26 / fRec13[0];
			float fTemp7 = fTemp6 + -2.0f;
			int iTemp8 = int(fTemp7);
			float fTemp9 = std::floor(fTemp7);
			float fTemp10 = fRec21[(IOTA0 - (std::min<int>(4097, std::max<int>(0, iTemp8)) + 1)) & 8191] * (fTemp9 + (3.0f - fTemp6)) + (fTemp6 + (-2.0f - fTemp9)) * fRec21[(IOTA0 - (std::min<int>(4097, std::max<int>(0, iTemp8 + 1)) + 1)) & 8191];
			iRec23[0] = 1103515245 * iRec23[1] + 12345;
			float fTemp11 = fTemp0 * std::max<float>(0.0f, std::min<float>(fTemp4, std::max<float>(fConst28 * (fConst24 - fTemp3) + 1.0f, 0.9f)) * (1.0f - fConst27 * fTemp2)) * (2.561137e-11f * fTemp0 * float(iRec23[0]) + 1.1f) + 0.5f * fTemp10;
			fVec2[IOTA0 & 8191] = fTemp11;
			float fTemp12 = fConst29 / fRec13[0];
			float fTemp13 = fTemp12 + -2.0f;
			int iTemp14 = int(fTemp13);
			float fTemp15 = std::floor(fTemp13);
			float fTemp16 = (fTemp12 + (-2.0f - fTemp15)) * fVec2[(IOTA0 - std::min<int>(4097, std::max<int>(0, iTemp14 + 1))) & 8191];
			float fTemp17 = fVec2[(IOTA0 - std::min<int>(4097, std::max<int>(0, iTemp14))) & 8191] * (fTemp15 + (3.0f - fTemp12));
			float fTemp18 = fTemp16 + fTemp17 + 0.3f * fTemp10 - mydsp_faustpower3_f(fTemp17 + fTemp16);
			fVec3[0] = fTemp18;
			fRec22[0] = 0.0f - fConst32 * (fConst31 * fRec22[1] - (fTemp18 + fVec3[1]));
			fRec21[IOTA0 & 8191] = fRec22[0];
			float fTemp19 = fRec21[IOTA0 & 8191];
			float fTemp20 = 3.1415927f * fTemp19 * fRec20[0] * fTemp5;
			float fTemp21 = std::cos(fTemp20);
			float fTemp22 = std::sin(fTemp20);
			float fTemp23 = fTemp19 * fTemp21 - fTemp22 * fRec24[1];
			float fTemp24 = fTemp21 * fTemp23 - fTemp22 * fRec25[1];
			float fTemp25 = fTemp21 * fTemp24 - fTemp22 * fRec26[1];
			float fTemp26 = fTemp21 * fTemp25 - fTemp22 * fRec27[1];
			float fTemp27 = fTemp21 * fTemp26 - fTemp22 * fRec28[1];
			float fTemp28 = fTemp21 * fTemp27 - fTemp22 * fRec29[1];
			float fTemp29 = fTemp21 * fTemp28 - fTemp22 * fRec30[1];
			float fTemp30 = fTemp21 * fTemp29 - fTemp22 * fRec31[1];
			float fTemp31 = fTemp21 * fTemp30 - fTemp22 * fRec32[1];
			fRec33[0] = fTemp21 * fTemp31 - fTemp22 * fRec33[1];
			fRec32[0] = fTemp22 * fTemp31 + fTemp21 * fRec33[1];
			fRec31[0] = fTemp22 * fTemp30 + fTemp21 * fRec32[1];
			fRec30[0] = fTemp22 * fTemp29 + fTemp21 * fRec31[1];
			fRec29[0] = fTemp22 * fTemp28 + fTemp21 * fRec30[1];
			fRec28[0] = fTemp22 * fTemp27 + fTemp21 * fRec29[1];
			fRec27[0] = fTemp22 * fTemp26 + fTemp21 * fRec28[1];
			fRec26[0] = fTemp22 * fTemp25 + fTemp21 * fRec27[1];
			fRec25[0] = fTemp22 * fTemp24 + fTemp21 * fRec26[1];
			fRec24[0] = fTemp22 * fTemp23 + fTemp21 * fRec25[1];
			float fTemp32 = 0.4f * fTemp5 * (fTemp19 * (1.0f - fRec20[0]) + fRec20[0] * (fTemp19 * fTemp22 + fRec24[1] * fTemp21)) + 0.33333334f * fTemp0 * (std::sin(6.2831855f * fRec17[0]) + 0.5f * std::sin(6.2831855f * fRec16[0]) + 0.2f * std::sin(6.2831855f * fRec15[0]) + 0.3f * fTemp0 * std::sin(6.2831855f * fRec12[0]));
			fVec4[IOTA0 & 4095] = fTemp32;
			float fTemp33 = 0.3f * fVec4[(IOTA0 - iConst33) & 4095];
			float fTemp34 = fTemp33 + fVec1[(IOTA0 - iConst17) & 2047] - 0.6f * fRec8[1];
			fVec5[IOTA0 & 4095] = fTemp34;
			fRec8[0] = fVec5[(IOTA0 - iConst34) & 4095];
			float fRec9 = 0.6f * fTemp34;
			fRec37[0] = 0.0f - fConst13 * (fConst12 * fRec37[1] - (fRec0[1] + fRec0[2]));
			fRec36[0] = fConst45 * (fRec0[1] + fConst44 * fRec37[0]) + fConst43 * fRec36[1];
			fVec6[IOTA0 & 2047] = 0.35355338f * fRec36[0] + 1e-20f;
			float fTemp35 = fVec6[(IOTA0 - iConst47) & 2047] + fTemp33 - 0.6f * fRec34[1];
			fVec7[IOTA0 & 2047] = fTemp35;
			fRec34[0] = fVec7[(IOTA0 - iConst48) & 2047];
			float fRec35 = 0.6f * fTemp35;
			float fTemp36 = fRec35 + fRec9;
			fRec41[0] = 0.0f - fConst13 * (fConst12 * fRec41[1] - (fRec2[1] + fRec2[2]));
			fRec40[0] = fConst59 * (fRec2[1] + fConst58 * fRec41[0]) + fConst57 * fRec40[1];
			fVec8[IOTA0 & 2047] = 0.35355338f * fRec40[0] + 1e-20f;
			float fTemp37 = fVec8[(IOTA0 - iConst61) & 2047] - (fTemp33 + 0.6f * fRec38[1]);
			fVec9[IOTA0 & 4095] = fTemp37;
			fRec38[0] = fVec9[(IOTA0 - iConst62) & 4095];
			float fRec39 = 0.6f * fTemp37;
			fRec45[0] = 0.0f - fConst13 * (fConst12 * fRec45[1] - (fRec6[1] + fRec6[2]));
			fRec44[0] = fConst73 * (fRec6[1] + fConst72 * fRec45[0]) + fConst71 * fRec44[1];
			fVec10[IOTA0 & 2047] = 0.35355338f * fRec44[0] + 1e-20f;
			float fTemp38 = fVec10[(IOTA0 - iConst75) & 2047] - (fTemp33 + 0.6f * fRec42[1]);
			fVec11[IOTA0 & 2047] = fTemp38;
			fRec42[0] = fVec11[(IOTA0 - iConst76) & 2047];
			float fRec43 = 0.6f * fTemp38;
			float fTemp39 = fRec43 + fRec39 + fTemp36;
			fRec49[0] = 0.0f - fConst13 * (fConst12 * fRec49[1] - (fRec1[1] + fRec1[2]));
			fRec48[0] = fConst87 * (fRec1[1] + fConst86 * fRec49[0]) + fConst85 * fRec48[1];
			fVec12[IOTA0 & 2047] = 0.35355338f * fRec48[0] + 1e-20f;
			float fTemp40 = fVec12[(IOTA0 - iConst89) & 2047] + fTemp33 + 0.6f * fRec46[1];
			fVec13[IOTA0 & 4095] = fTemp40;
			fRec46[0] = fVec13[(IOTA0 - iConst90) & 4095];
			float fRec47 = 0.0f - 0.6f * fTemp40;
			fRec53[0] = 0.0f - fConst13 * (fConst12 * fRec53[1] - (fRec5[1] + fRec5[2]));
			fRec52[0] = fConst101 * (fRec5[1] + fConst100 * fRec53[0]) + fConst99 * fRec52[1];
			fVec14[IOTA0 & 2047] = 0.35355338f * fRec52[0] + 1e-20f;
			float fTemp41 = fVec14[(IOTA0 - iConst103) & 2047] + fTemp33 + 0.6f * fRec50[1];
			fVec15[IOTA0 & 4095] = fTemp41;
			fRec50[0] = fVec15[(IOTA0 - iConst104) & 4095];
			float fRec51 = 0.0f - 0.6f * fTemp41;
			fRec57[0] = 0.0f - fConst13 * (fConst12 * fRec57[1] - (fRec3[1] + fRec3[2]));
			fRec56[0] = fConst115 * (fRec3[1] + fConst114 * fRec57[0]) + fConst113 * fRec56[1];
			fVec16[IOTA0 & 2047] = 0.35355338f * fRec56[0] + 1e-20f;
			float fTemp42 = 0.6f * fRec54[1] + fVec16[(IOTA0 - iConst117) & 2047] - fTemp33;
			fVec17[IOTA0 & 4095] = fTemp42;
			fRec54[0] = fVec17[(IOTA0 - iConst118) & 4095];
			float fRec55 = 0.0f - 0.6f * fTemp42;
			fRec61[0] = 0.0f - fConst13 * (fConst12 * fRec61[1] - (fRec7[1] + fRec7[2]));
			fRec60[0] = fConst129 * (fRec7[1] + fConst128 * fRec61[0]) + fConst127 * fRec60[1];
			fVec18[IOTA0 & 2047] = 0.35355338f * fRec60[0] + 1e-20f;
			float fTemp43 = 0.6f * fRec58[1] + fVec18[(IOTA0 - iConst131) & 2047] - fTemp33;
			fVec19[IOTA0 & 2047] = fTemp43;
			fRec58[0] = fVec19[(IOTA0 - iConst132) & 2047];
			float fRec59 = 0.0f - 0.6f * fTemp43;
			fRec0[0] = fRec58[1] + fRec54[1] + fRec50[1] + fRec46[1] + fRec42[1] + fRec38[1] + fRec8[1] + fRec34[1] + fRec59 + fRec55 + fRec51 + fRec47 + fTemp39;
			fRec1[0] = fRec42[1] + fRec38[1] + fRec8[1] + fRec34[1] + fTemp39 - (fRec58[1] + fRec54[1] + fRec50[1] + fRec46[1] + fRec59 + fRec55 + fRec47 + fRec51);
			float fTemp44 = fRec39 + fRec43;
			fRec2[0] = fRec50[1] + fRec46[1] + fRec8[1] + fRec34[1] + fRec51 + fRec47 + fTemp36 - (fRec58[1] + fRec54[1] + fRec42[1] + fRec38[1] + fRec59 + fRec55 + fTemp44);
			fRec3[0] = fRec58[1] + fRec54[1] + fRec8[1] + fRec34[1] + fRec59 + fRec55 + fTemp36 - (fRec50[1] + fRec46[1] + fRec42[1] + fRec38[1] + fRec51 + fRec47 + fTemp44);
			float fTemp45 = fRec9 + fRec43;
			float fTemp46 = fRec35 + fRec39;
			fRec4[0] = fRec54[1] + fRec46[1] + fRec38[1] + fRec34[1] + fRec55 + fRec47 + fTemp46 - (fRec58[1] + fRec50[1] + fRec42[1] + fRec8[1] + fRec59 + fRec51 + fTemp45);
			fRec5[0] = fRec58[1] + fRec50[1] + fRec38[1] + fRec34[1] + fRec59 + fRec51 + fTemp46 - (fRec54[1] + fRec46[1] + fRec42[1] + fRec8[1] + fRec55 + fRec47 + fTemp45);
			float fTemp47 = fRec9 + fRec39;
			float fTemp48 = fRec35 + fRec43;
			fRec6[0] = fRec58[1] + fRec46[1] + fRec42[1] + fRec34[1] + fRec59 + fRec47 + fTemp48 - (fRec54[1] + fRec50[1] + fRec38[1] + fRec8[1] + fRec55 + fRec51 + fTemp47);
			fRec7[0] = fRec54[1] + fRec50[1] + fRec42[1] + fRec34[1] + fRec55 + fRec51 + fTemp48 - (fRec58[1] + fRec46[1] + fRec38[1] + fRec8[1] + fRec59 + fRec47 + fTemp47);
			float fTemp49 = 0.37f * (fRec1[0] + fRec2[0]);
			float fTemp50 = fConst135 * fRec62[1];
			fRec62[0] = fTemp49 - (fTemp50 + fConst134 * fRec62[2]);
			float fTemp51 = fConst134 * fRec62[0];
			float fTemp52 = 0.5f * (fTemp51 + fRec62[2] + fTemp49 + fTemp50 + (fTemp51 + fTemp50 + fRec62[2] - fTemp49));
			float fTemp53 = fConst138 * fRec63[1];
			fRec63[0] = fTemp52 - (fTemp53 + fConst137 * fRec63[2]);
			float fTemp54 = fConst137 * fRec63[0];
			float fTemp55 = 0.75f * fTemp32;
			output0[i0] = FAUSTFLOAT(fTemp55 + 0.125f * (fTemp54 + fRec63[2] + fTemp52 + fTemp53 + (fTemp54 + fTemp53 + fRec63[2] - fTemp52)));
			float fTemp56 = 0.37f * (fRec1[0] - fRec2[0]);
			float fTemp57 = fConst135 * fRec64[1];
			fRec64[0] = fTemp56 - (fTemp57 + fConst134 * fRec64[2]);
			float fTemp58 = fConst134 * fRec64[0];
			float fTemp59 = 0.5f * (fTemp58 + fRec64[2] + fTemp56 + fTemp57 + (fTemp58 + fTemp57 + fRec64[2] - fTemp56));
			float fTemp60 = fConst138 * fRec65[1];
			fRec65[0] = fTemp59 - (fTemp60 + fConst137 * fRec65[2]);
			float fTemp61 = fConst137 * fRec65[0];
			output1[i0] = FAUSTFLOAT(fTemp55 + 0.125f * (fTemp61 + fRec65[2] + fTemp59 + fTemp60 + (fTemp61 + fTemp60 + fRec65[2] - fTemp59)));
			iVec0[1] = iVec0[0];
			fRec11[1] = fRec11[0];
			fRec10[1] = fRec10[0];
			IOTA0 = IOTA0 + 1;
	...
	#define FAUST_FILE_NAME "Whistle.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("freq", fHslider0, 261.6f, 261.6f, 1046.4f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("pressure", fHslider1, 0.96f, 0.0f, 0.99f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, freq, "freq", fHslider0, 261.6f, 261.6f, 1046.4f, 1.0f) \
		p(HORIZONTALSLIDER, pressure, "pressure", fHslider1, 0.96f, 0.0f, 0.99f, 0.01f) \
...
Whistle::Whistle() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void Whistle::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void Whistle::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float Whistle::getParamValue(const std::string& path)
{
